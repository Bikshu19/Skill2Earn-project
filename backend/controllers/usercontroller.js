...
const createUserDetails = async (req, res) => {
  try {
    ...
    if (existing && existing.location && existing.address) {
      return res.status(400).json({ message: 'Details already exist. Use update instead.' });
    }
...
module.exports = { registerUser,loginUser,getUserProfile ,updateUserProfile,createUserDetails,updateUserDetails,addSkillToUser };
