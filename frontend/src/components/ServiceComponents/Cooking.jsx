    ...
    try {
      ...
      */
      ...
      const mockTailoringData = [
        {
          id: 1,
          title: "Traditional South Indian Cooking Tutor",
          description:
            "Expert in teaching authentic South Indian recipes including idlis, dosas, sambar, and chutneys. Conducts homely classes with focus on traditional flavors.",
          image:
            "https://images.unsplash.com/photo-1604908177522-040d29f2b1c3?w=600&h=400&fit=crop",
          ...
          rating: 4.8,
          experience: "12 years",
          specialties: ["South Indian", "Breakfast Dishes", "Vegetarian"],
        },
        {
          id: 2,
          title: "Village Style Cooking Teacher",
          description:
            "Teaches traditional village-style cooking on wood fire stoves with organic ingredients. Classes include curries, rotis, and homemade pickles.",
          image:
            "https://images.unsplash.com/photo-1617196035935-f953f8d670e3?w=600&h=400&fit=crop",
          username: "Ramu",
          ...
          rating: 4.7,
          experience: "20 years",
          specialties: ["Village Recipes", "Pickles", "Curries"],
        },
        {
          id: 3,
          title: "North Indian Cuisine Expert",
          description:
            "Specialist in North Indian dishes like butter chicken, paneer masala, biryani, and kebabs. Offers both online and offline cooking classes.",
          image:
          ...
          rating: 4.9,
          experience: "14 years",
          specialties: ["North Indian", "Non-Veg Curries", "Biryani"],
        },
        {
          id: 4,
          title: "Home Baker & Cake Artist",
          description:
            "Teaches baking basics to advanced cake decoration. Known for delicious homemade breads, cookies, and designer cakes.",
          image:
            "https://images.unsplash.com/photo-1514516870926-2059890f8c79?w=600&h=400&fit=crop",
          ...
          rating: 4.8,
          experience: "8 years",
          specialties: ["Baking", "Cakes", "Cookies"],
        },
        {
          id: 5,
          title: "Street Food Masterclass",
          description:
            "Conducts classes on popular Indian street foods like chaats, samosas, pav bhaji, and golgappa. Brings city flavors to home kitchens.",
          image:
            "https://images.unsplash.com/photo-1604908177350-df7f36a8709a?w=600&h=400&fit=crop",
          username: "Imran Khan",
          ...
          rating: 4.7,
          experience: "10 years",
          specialties: ["Street Food", "Snacks", "Chaats"],
        },
        {
          id: 6,
          title: "Healthy Cooking Specialist",
          description:
            "Focuses on teaching nutritious recipes with millet, quinoa, and organic veggies. Perfect for health-conscious families and beginners.",
          image:
            "https://images.unsplash.com/photo-1598511720005-9c956f59d7f5?w=600&h=400&fit=crop",
          ...
          rating: 4.9,
          experience: "9 years",
          specialties: ["Healthy Cooking", "Millets", "Vegan"],
        },
        {
          id: 7,
          title: "Royal Hyderabadi Biryani Tutor",
          description:
            "Known for authentic Hyderabadi biryani and kebabs. Conducts step-by-step biryani masterclasses for food lovers.",
          image:
            "https://images.unsplash.com/photo-1606851091708-5f7b8b702d79?w=600&h=400&fit=crop",
          username: "Salman Ali",
          ...
          rating: 5.0,
          experience: "18 years",
          specialties: ["Biryani", "Kebabs", "Mughlai Cuisine"],
        },
        {
          id: 8,
          title: "Kids Cooking Workshop",
          description:
            "Fun and interactive classes for children to learn sandwiches, pasta, desserts, and easy healthy snacks.",
          image:
          ...
          rating: 4.6,
          experience: "6 years",
          specialties: ["Kids Cooking", "Snacks", "Desserts"],
        },
        {
          id: 9,
          title: "International Cuisine Chef",
          description:
            "Offers classes on Italian, Chinese, and Continental recipes. Great for foodies who love experimenting with global cuisines.",
          image:
          ...
          rating: 4.9,
          experience: "15 years",
          specialties: ["Italian", "Chinese", "Continental"],
        },
        {
          id: 10,
          title: "Pickles & Preserves Specialist",
          description:
            "Teaches age-old recipes of homemade pickles, papads, and jams. Uses organic ingredients and village-style preservation methods.",
          image:
            "https://images.unsplash.com/photo-1625948516113-b8e1b0c8f7a0?w=600&h=400&fit=crop",
          ...
          rating: 4.7,
          experience: "22 years",
          specialties: ["Pickles", "Preserves", "Village Recipes"],
        },
      ];
