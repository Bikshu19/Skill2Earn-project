  ...
  const fetchTailoringSkills = async () => {
    try {
      ...
      const mockTailoringData = [
        {
         id: 1,
    title: "Wedding Caterer & Chef",
    description:
      "Specialist in large wedding feasts with North & South Indian delicacies.",
    image:
    ...
    rating: 4.9,
    experience: "15 years",
    specialties: ["Biryani", "Paneer Curries", "Traditional Thali"],
    isPublic: true,
        },
        {
         id: 2,
    ...
    description:
      "Expert in custom cakes, pastries, and international desserts for parties.",
    image:
      "https://images.unsplash.com/photo-1542826438-30bf8ba1e2f0?w=600&h=400&fit=crop",
    ...
    rating: 4.8,
    experience: "8 years",
    specialties: ["Fondant Cakes", "Cheesecake", "Cupcakes"],
    isPublic: true,
        },
        {
           id: 3,
    title: "South Indian Cuisine Expert",
    description:
      "Authentic South Indian meals with dosa, idli, sambhar, and chutneys.",
    image:
    ...
    rating: 5.0,
    experience: "12 years",
    specialties: ["Masala Dosa", "Idli Vada", "Coconut Chutneys"],
    isPublic: true,
        },
        {
         id: 4,
    title: "Chinese & Indo-Chinese Chef",
    description:
      "Popular Chinese and fusion Indo-Chinese street-style delicacies.",
    image:
      "https://images.unsplash.com/photo-1603133872878-684f1a9ef1d9?w=600&h=400&fit=crop",
    ...
    rating: 4.7,
    experience: "9 years",
    specialties: ["Manchurian", "Hakka Noodles", "Spring Rolls"],
    isPublic: true,
        },
        {
           id: 5,
    title: "Street Food & Snacks Specialist",
    description:
      "Chaat, golgappa, pav bhaji and all-time favorite Indian snacks.",
    image:
      "https://images.unsplash.com/photo-1601050690290-df0c24f6f42b?w=600&h=400&fit=crop",
    ...
    rating: 4.8,
    experience: "7 years",
    specialties: ["Chaat", "Pani Puri", "Pav Bhaji"],
    isPublic: true,
        },
        {
          id: 6,
    title: "Healthy Diet Food Chef",
    description:
      "Meal prep expert offering healthy, low-calorie, and high-protein meals.",
    image:
    ...
    rating: 4.9,
    experience: "5 years",
    specialties: ["Keto Meals", "Vegan Bowls", "Salads"],
    isPublic: true,
        },
        // PRIVATE / PREMIUM (4)
        {
          id: 7,
    title: "Luxury Banquet Catering",
    description:
      "Five-star catering with international cuisines and live counters.",
    image:
    ...
    rating: 5.0,
    experience: "14 years",
    specialties: ["Italian", "Mediterranean", "Live Grills"],
    isPremium: true,
    isPublic: false,
        },
        {
          id: 8,
    title: "International Chef (Continental)",
    description:
      "Trained abroad, specializes in European and continental fine dining.",
    image:
      "https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=600&h=400&fit=crop",
    username: "Ravi Mehta",
    ...
    rating: 4.9,
    experience: "11 years",
    specialties: ["Pasta", "Steaks", "Soups"],
    isPremium: true,
    isPublic: false,
        },
        {
          id: 9,
    title: "Destination Wedding Caterer",
    description:
      "Available nationwide for destination wedding food arrangements.",
    image:
      "https://images.unsplash.com/photo-1529042410759-befb1204b468?w=600&h=400&fit=crop",
    username: "Sunita Joshi",
    address: "Kolkata, India",
    category: "Destination Catering",
    ...
    rating: 4.8,
    experience: "13 years",
    specialties: ["On-Site Setup", "Full Course Meals", "Buffets"],
    isPremium: true,
    isPublic: false,
        },
        {
    ...
    description:
      "Cooked for film stars & events, offering luxury dining experiences.",
    image:
    ...
    rating: 4.9,
    experience: "16 years",
    specialties: ["Fine Dining", "Fusion", "Luxury Catering"],
    isPremium: true,
    isPublic: false,
        },
      ];
      ...
      <div className="relative z-10 p-6">
        ...
        <div className="max-w-7xl mx-auto text-center mb-16">
          <h1 className="text-6xl md:text-7xl font-bold mb-6 text-[#1F2937]">
            Master <span className="text-[#DB2777]">Women</span> Cooking
          </h1>
          <p className="text-xl text-[#374151] max-w-2xl mx-auto leading-relaxed mb-8">
            Discover skilled <span className="text-[#DB2777]">Cooking professionals</span> for
          ...
          <div className="flex justify-center gap-8 mt-8">
            <div className="text-center">
              ...
              <div className="text-[#374151]">Expert Chefs</div>
            </div>
            <div className="text-center">
