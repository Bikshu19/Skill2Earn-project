      ...
      <div className="relative z-10 p-6">
        ...
        <div className="max-w-7xl mx-auto text-center mb-16">
          ...
          <p className="text-xl text-[#374151] max-w-2xl mx-auto leading-relaxed mb-8">
            Discover skilled <span className="text-[#DB2777]">tailoring professionals</span> for
          ...
          <div className="flex justify-center gap-8 mt-8">
            <div className="text-center">
              ...
              <div className="text-[#374151]">Expert Tailors</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-[#DB2777]">50k+</div>
            ...
            >
              ...
              <div className="w-full lg:w-1/2 space-y-6">
                ...
                <div className="flex gap-4">
                  <button className="flex-1 bg-pink-600 text-white py-4 px-6 rounded-xl font-semibold text-lg transition-all duration-300 hover:bg-pink-700 transform hover:scale-105 shadow-xl">
                    Book Consultation
                  </button>
